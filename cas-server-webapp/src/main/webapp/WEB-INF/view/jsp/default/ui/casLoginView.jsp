...
<%
 String casPath = request.getContextPath();
...
<div class="box" id="login">
  ...
  <form:form method="post" id="fm1" commandName="${commandName}" htmlEscape="true">
    ...
    <section class="row">
      ...
      <c:choose>
        ...
        <c:otherwise>
          ...
          <form:input cssClass="required"  placeholder="Username" cssErrorClass="error" id="username" size="25" tabindex="1" accesskey="${userNameAccessKey}" path="username" autocomplete="off" htmlEscape="true" />
        </c:otherwise>
      </c:choose>
    </section>
    ...
    <section class="row">
      ...
      <form:password cssClass="required"  placeholder="Password" cssErrorClass="error" id="password" size="25" tabindex="2" path="password"  accesskey="${passwordAccessKey}" htmlEscape="true" autocomplete="off" />
    </section>
    ...
    <section>
    	 <p class="indra-signup">
              <a href="${casPath }/umsAdmin/public/toForgetMyPwd" id="forgot" name="forgot">Unable to access your account?</a><br>
         </p>
    </section>
