...
<body>
   <div class="permis">
	   <img src="<%=request.getContextPath()%>/styles/images/error2.png" alt="permission" width="50" height="50"> 
	   <small class="ld">哎呀......出错啦！<fmt:message key="${errorCode }"></fmt:message></small>
	   <h3 id="countdown"></h3>
